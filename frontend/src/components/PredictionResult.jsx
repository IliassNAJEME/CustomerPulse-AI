...
const RISK_CONFIG = {
  LOW: { badge: 'badge-success', bar: 'bg-emerald-500', icon: '✓', label: 'FAIBLE', color: '#10b981' },
  MEDIUM: { badge: 'badge-warning', bar: 'bg-amber-500', icon: '!', label: 'MOYEN', color: '#f59e0b' },
  HIGH: { badge: 'badge-danger', bar: 'bg-red-500', icon: '⚠', label: 'ÉLEVÉ', color: '#ef4444' },
};
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="h-24 w-24">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={chartData} dataKey="value" cx="50%" cy="50%" innerRadius={35} outerRadius={50}>
